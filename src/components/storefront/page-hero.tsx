    ...
    <section className={cn("pt-8 sm:pt-10", className)}>
      <Container>
        <div className="grid gap-6 lg:grid-cols-[1.08fr_0.92fr] lg:items-end">
          <div className="space-y-4 rounded-[2rem] bg-[linear-gradient(135deg,#fff8fa_0%,#fff0f4_46%,#fffdfd_100%)] p-6 shadow-[0_24px_70px_-48px_rgba(233,165,186,0.46)] ring-1 ring-[rgba(248,192,205,0.42)] sm:p-8">
            <p className="text-[12px] font-semibold uppercase tracking-[0.28em] text-[#ff7e95]">{eyebrow}</p>
            <h1 className="max-w-4xl text-[2.6rem] font-semibold leading-[1.02] tracking-[-0.04em] text-[#2f2b32] sm:text-[4.25rem]">
              {title}
            </h1>
            <p className="max-w-3xl text-[15px] leading-8 text-[#6a6470] sm:text-[17px]">{description}</p>
          </div>

          {side ? (
            <div className="rounded-[2rem] bg-white/92 p-6 shadow-[0_24px_70px_-52px_rgba(214,187,198,0.7)] ring-1 ring-[rgba(241,225,230,0.95)] backdrop-blur-xl sm:p-7">
              {side}
            </div>
          ) : null}
        </div>
